...
const Navigation = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <nav className="fixed left-0 top-0 z-50 hidden h-screen w-64 flex-col border-r border-cyan-500/20 bg-[#0A0F1E]/95 p-6 backdrop-blur-xl md:flex">
      ...
      <Sheet open={isOpen} onOpenChange={onClose}>
        <SheetContent
          side="left"
          className="w-[300px] border-r border-cyan-500/20 bg-[#0A0F1E]/95 p-0 backdrop-blur-xl"
        >
          <SheetHeader className="border-b border-cyan-500/20 p-6">
